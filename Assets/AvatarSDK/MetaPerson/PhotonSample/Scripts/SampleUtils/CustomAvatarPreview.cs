...
namespace AvatarSDK.MetaPerson.Photon
{
	public class CustomAvatarPreview : AvatarPreview
	{
		protected override void OnEnable()
		{
			...
			if (PlayerPrefs.HasKey(StringConstants.PlayerCustomAvatarGenderPrefKey))
				avatarGender = PlayerPrefs.GetString(StringConstants.PlayerCustomAvatarGenderPrefKey).StringToAvatarGender();
